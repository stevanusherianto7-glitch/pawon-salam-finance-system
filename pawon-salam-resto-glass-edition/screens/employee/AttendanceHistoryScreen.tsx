  ...
  return (
    <div className="min-h-screen w-full relative overflow-hidden font-sans">
      ...
      <div className="relative z-10 px-4 space-y-4 pb-32 h-full overflow-y-auto">
        ...
        <div className="bg-black/20 backdrop-blur-xl border border-white/10 rounded-2xl p-2 flex items-center gap-2">
            {(['WEEK', 'MONTH', 'ALL'] as FilterType[]).map((type) => {
              ...
              return (
                <button
                  ...
                  className={`relative flex-1 py-3 text-xs font-bold rounded-xl transition-all duration-300
        ...
        {isLoading ? (
            ...
            <>
              ...
              <div className="bg-black/20 backdrop-blur-2xl border border-white/10 rounded-2xl p-4">
                  <div className="flex items-center gap-2 mb-4">
                      <BarChart3 size={16} className="text-white/50"/>
                      <h3 className="font-bold text-white/80 text-xs uppercase tracking-wider">Statistik Ringkas</h3>
                  </div>
                  
                  <div className="grid grid-cols-2 gap-3 mb-4">
                       <div className="bg-white/5 p-3 rounded-xl border border-white/10">
                           <div className="flex items-center gap-1.5 text-xs text-blue-300 mb-1">
                               <CheckCircle2 size={12}/> Total Hari Kerja
                           </div>
                           <p className="text-lg font-bold text-white leading-none">{totalLogs} <span className="text-[10px] font-medium text-white/40">Hari</span></p>
                       </div>
                       <div className="bg-white/5 p-3 rounded-xl border border-white/10">
                           <div className="flex items-center gap-1.5 text-xs text-orange-300 mb-1">
                               <Clock size={12}/> Rata-rata
                           </div>
                           <p className="text-lg font-bold text-white leading-none">{avgHours}j {avgMinutes}m</p>
                       </div>
                  </div>
              </div>
                      ...
                      >
                          ...
                          <div className="flex items-center gap-3">
                              <div className="flex flex-col items-end">
                                  ...
                                  <span className="text-[10px] font-bold mt-1" style={{ color: statusColor }}>
                      ...
                      {isExpanded && (
                          <div className="px-4 pb-4 pt-0 animate-fade-in">
                              <div className="pt-4 border-t border-dashed border-white/10 grid grid-cols-2 gap-3">
                                  <div className="col-span-2 flex justify-between bg-black/20 p-3 rounded-lg border border-white/10">
                                     <div className="flex items-center gap-2">
                                        <Clock size={14} className="text-white/40"/>
                                        <span className="text-xs text-white/50">Durasi Kerja:</span>
                                     </div>
                                  ...
                                  <div className="col-span-1 p-3 rounded-lg border border-orange-400/20 bg-black/20 flex flex-col gap-2">
                                      <div className="flex items-center gap-2">
                                          <MapPin size={14} className="text-orange-400" />
                                          <span className="text-xs font-semibold text-orange-300">Lokasi Check-in</span>
                                      </div>
                                  ...
                                  <div className="col-span-1 p-3 rounded-lg border border-orange-400/20 bg-black/20 flex flex-col gap-2">
                                      <div className="flex items-center gap-2">
                                          ...
                                          <span className="text-xs font-semibold text-orange-300">Bukti Foto</span>
                                      </div>
                                      {log.photoInUrl ? (
                                          <div className="h-12 w-full rounded bg-black/20 border border-white/10 overflow-hidden relative group">
                                             <img 
                                              src={log.photoInUrl} 
                                              alt="Selfie" 
                                          ...
                                          <div className="h-12 w-full rounded bg-black/20 border border-dashed border-white/10 flex items-center justify-center">
