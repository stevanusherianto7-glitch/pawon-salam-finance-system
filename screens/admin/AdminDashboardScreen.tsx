            ...
            {user?.role === UserRole.BUSINESS_OWNER ? (
                <div className="pt-10 pb-20 px-4 rounded-b-[3rem] relative overflow-hidden bg-[#0B0F19] shadow-2xl">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="bg-gradient-to-br from-gray-900/90 to-black/80 backdrop-blur-xl rounded-3xl p-5 border border-white/10 shadow-2xl relative group overflow-hidden">
                            {/* Decorative Shine */}
                            ...
                            <div className="flex items-center gap-5">
                                ...
                                <div className="relative shrink-0">
                                    <div className="p-1 rounded-2xl bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md border border-white/10 shadow-inner group-hover:border-amber-500/30 transition-colors duration-500">
                                        <img src={user?.avatarUrl} alt="Avatar" className="w-16 h-16 rounded-xl object-cover shadow-lg cursor-pointer hover:scale-105 transition-transform duration-300" onClick={handleAvatarClick} />
                                    </div>
                                    {/* Crown Icon floating */}
                                    <div className="absolute -top-2 -right-2 bg-gradient-to-br from-amber-300 to-amber-600 p-1.5 rounded-full shadow-lg border border-amber-200 animate-pulse-slow">
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-center gap-2 mb-1">
                                        <span className="px-2 py-0.5 rounded-md bg-amber-500/20 border border-amber-500/30 text-[8px] font-bold text-amber-400 uppercase tracking-widest backdrop-blur-sm">
                                            Executive
                                        </span>
                                    </div>
                                    <h2 className="text-xl font-black text-white leading-tight tracking-tight mb-0.5 drop-shadow-md">{user?.name}</h2>
                                ...
                                <button onClick={logout} className="p-3 bg-white/5 hover:bg-white/10 rounded-2xl text-gray-400 border border-white/5 hover:text-white transition-all hover:scale-105 active:scale-95 shadow-lg backdrop-blur-sm group/btn">
                                    <LogOut size={20} className="group-hover/btn:text-red-400 transition-colors" />
                                </button>
                            </div>
                        </div>
                    </div>
            ...
            {user?.role === UserRole.BUSINESS_OWNER ? (
                <div className="px-4 -mt-16 relative z-10 space-y-4">
                    ...
                    <div className="space-y-3">
                        {eotm && (
                            <div onClick={() => onNavigate && onNavigate('certificate')} className="bg-gradient-to-r from-amber-50 to-white rounded-xl p-3 border border-amber-100 flex items-center justify-between cursor-pointer active:scale-98 transition-transform shadow-sm">
                                <div className="flex items-center gap-3">
                                    <div className="relative">
                                        <img src={eotm.avatarUrl} className="w-8 h-8 rounded-full object-cover border border-orange-200" />
                                ...
                                <div className="text-right">
                                    <span className="text-sm font-bold text-gray-800">{eotm.avgScore}</span>
