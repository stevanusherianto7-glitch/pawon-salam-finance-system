...
export const CertificateScreen: React.FC<Props> = ({ onBack }) => {
  ...
  return (
    <div className="bg-gray-200 min-h-screen flex flex-col overflow-hidden">
       <div className="px-4 py-4 flex items-center justify-between bg-white shadow-md z-50 shrink-0">
           <button onClick={onBack} className="p-2 bg-gray-100 rounded-full text-gray-700 hover:bg-gray-200 transition-colors">
               <ArrowLeft size={20} />
           </button>
           <h2 className="text-gray-800 font-bold text-sm">Sertifikat Digital</h2>
           <button 
             onClick={handleDownloadPDF}
             disabled={downloading}
             className="flex items-center gap-2 px-4 py-2 bg-orange-600 hover:bg-orange-500 text-white rounded-full text-xs font-bold transition-all active:scale-95 disabled:opacity-50 shadow-lg shadow-orange-500/20"
           >
